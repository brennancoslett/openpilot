...
All four conditions together. Vision ACC also runs with pcmCruise=False but
...
def test_silent_in_preap_vision_acc_mode_even_when_uncalibrated():
  # vision ACC: op-long software cruise (pcmCruise=False) with NO pedal —
